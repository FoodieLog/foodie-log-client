...
const Button: React.FC<ButtonProps> = ({
  ...
  switch (variant) {
    case "primary":
      variantStyles =
        "w-full py-3.5 text-white bg-mint hover:bg-mint-light focus:ring-4 focus:ring-blue-300 font-medium  rounded-xl text-sm px-5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800";
      break;
    case "secondary":
      variantStyles =
